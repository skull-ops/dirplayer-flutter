...
class FieldInspector extends StatefulWidget {
  final PlayerVM vm;
  final FieldMember member;

  const FieldInspector({super.key, required this.vm, required this.member});

  @override
  State<StatefulWidget> createState() => _FieldInspectorState();
}
...
class _FieldInspectorState extends State<FieldInspector> {
  ...
  Widget build(BuildContext context) {
    return Inspector(
      title: "Field: ${widget.member.getName()}", 
      child: Container(
